...
export type ClassicReference = {
  bookId: 'ditiansui' | 'qiongtong' | 'lixu' | 'sanming' | 'yuanhai' | 'wuxing';
  chapterId: string;
  label: string;
};
...
export const classicShelf = [
  ...
  { id: 'sanming', title: '三命通会', dynasty: '明', status: '全文', chapterCount: 12, unit: '卷', summary: '汇集禄命法、子平法、神煞与诸家论法的大型命理文献。', path: 'knowledge/classics/sanming/index.json' },
  { id: 'yuanhai', title: '渊海子平', dynasty: '宋元以来', status: '全文·底本待校', chapterCount: 74, summary: '子平法重要汇编，包含定格、诗诀、六亲和岁运诸法。', path: 'knowledge/classics/yuanhai/index.json' },
  ...
  { id: 'wuxing', title: '五行精纪', dynasty: '宋', status: '全文', chapterCount: 34, unit: '卷', summary: '汇集唐宋禄命材料，是研究早期命理体系的重要文献。', path: 'knowledge/classics/wuxing/index.json' },
